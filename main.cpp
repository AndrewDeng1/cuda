...
int main() {
    ...
    auto a5 = a3+a4;
    a5->print();
    a5->grad = make_shared<Tensor>(vector<int>{2, 3, 3}, vector<float>{1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f}, true);
    a5->grad->print();
    a5->backward_fn();
    a3->grad->print();
    a4->grad->print();
    ...
    // vector<float> data2 = {7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f};
    // auto t2 = make_shared<Tensor>(shape, data2, true);
    
    // // Add the tensors
    // auto result = t1 + t2;
    
    // // Print the result
    // cout << "Result tensor shape: [";
    // for(int i = 0; i < result->shape.size(); i++) {
    //     cout << result->shape[i];
    //     if(i < result->shape.size() - 1) cout << ", ";
    // }
    // cout << "]" << endl;
