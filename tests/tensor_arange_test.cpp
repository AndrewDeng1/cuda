...
int main() {
    ...
    Tensor a3 = arange(0.0f, 1.0f, 0.25f);
    assert(a3.shape()[0] == 4);
    ...
    Tensor a5 = arange(5, 0, 1);  // end < start with positive step
    assert(a5.shape()[0] == 0);
    cout << "PASSED" << endl;
...
// ===== ARANGE FLOAT STEP =====
// PASSED
// ===== ARANGE NEGATIVE STEP =====
// PASSED
// ===== ARANGE EMPTY =====
// PASSED
// ===== ALL ARANGE TESTS PASSED =====